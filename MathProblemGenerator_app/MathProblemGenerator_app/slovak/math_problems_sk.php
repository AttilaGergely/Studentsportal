...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <?php if (!empty($mathProblem)) : ?>
        ...
        <div id="container">
            ...
            <h3 id="problemstatement">Vyhlásenie o probléme:</h4>
            <p id="text"><?php echo $mathProblem['problem']; ?></p>
        

        <a style="text-decoration: underline" href="https://inspera.atlassian.net/wiki/spaces/KB/pages/62062830/MathQuill+symbols" target="_blank">Dokumentácia o tom, ako písať matematické operátory</a>
        ...
        <button id="check_button">Odoslať odpoveď</button>
      </div>
        ...
        <div id="myModal" class="modal">
            <div class="modal-content">
                <h3 id="modalTitle"></h3>
                <p id="modalText"></p>
                <button id="modalButton">Generovať nový príklad</button>
            </div>
        </div>
  ...
  $(document).ready(function() {
    ...
    $('#check_button').click(function() {
      ...
      try {
        if (studentAnswer == correctAnswer) {
          showModal("Správna odpoveď!", "Odpoveď je správna.");
          updateScores(true);
        } else {
          showModal("Nesprávna odpoveď!", "Odpoveď je nesprávna.");
          updateScores(false);
        }
      } catch (error) {
        showModal("Chyba", "Pri spracovaní vašej odpovede sa vyskytla chyba. Uistite sa, že ide o platný matematický výraz.");
      }
    ...
    <?php else : ?>
        <p>Nenašli sa žiadne matematické problémy.</p>
    <?php endif; ?>
